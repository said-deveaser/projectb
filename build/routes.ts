...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { WaDictionariesController } from './../src/api/routers/wa-dictionaries/waDictionariesController';
...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        app.get('/api/wa-dictionaries/big-cities',
            ...(fetchMiddlewares<RequestHandler>(WaDictionariesController)),
            ...(fetchMiddlewares<RequestHandler>(WaDictionariesController.prototype.getBigCities)),

            function WaDictionariesController_getBigCities(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
                ...
                const controller = new WaDictionariesController();


              const promise = controller.getBigCities.apply(controller, validatedArgs as any);
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/wa-dictionaries/city-districts/:cityid',
            ...(fetchMiddlewares<RequestHandler>(WaDictionariesController)),
            ...(fetchMiddlewares<RequestHandler>(WaDictionariesController.prototype.getCityDistricts)),

            function WaDictionariesController_getCityDistricts(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getCityDistricts.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
